/**
 * PrBoom DOOM WebAssembly Port
 * Original: https://github.com/joeheyming/doom (GPL-2.0)
 *
 * Modifications for vector-doom (JSKitty):
 * - Line ~841: Changed music fetch URL from external netlify to local ./music/
 */
var Module = (function () {
  var _scriptDir =
  ...
  return function (Module) {
    ...
    var ASM_CONSTS = [
      ...
      function ($0, $1) {
        ...
        // Always use local files (modified for WebXDC)
